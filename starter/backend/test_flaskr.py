...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = 'postgresql://postgres:0541468855@localhost:5432/trivia_test'
    ...
    def test_404_sent_requesting_for_invalid_page(self):
    ...
    def test_405_if_question_creation_not_allowed(self):
        res = self.client().post('/questions/10', self.new_question)
        data = json.loads(res.data)
    ...
    def test_404_if_search_does_not_exist(self):
        res = self.client().get('/search', json={'searchTerm': 'mohammed'})
        data = json.load(res.data)
    ...
    def test_404_get_requesting_for_invalid_category_id(self):
    ...
    def test_400_if_quiz_fail(self):
